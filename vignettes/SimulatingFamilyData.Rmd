...
sim1000G depends on two R packages stringr and hapsim. Stringr and hapsim are included in CRAN and can be installed as follows:
...
```{R,  eval=FALSE}
install.packages("sim1000G_1.32.tar.gz",repos=NULL, source=T)
```
